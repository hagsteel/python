...
if __name__ == "__main__":
    ...
    root = Button(screen, text="**", width="4", height="2",
                  command=lambda: press("**"))
    root.grid(row=7, column=1)

    dot = Button(screen, text=".", width="4", height="2",
                 command=lambda: press("."))
    dot.grid(row=5, column=0)

    bracket_open = Button(screen, text="(", width="4", height="2",
                          command=lambda: press("("))
    bracket_open.grid(row=7, column=2)

    bracket_close = Button(screen, text=")", width="4", height="2",
                           command=lambda: press(")"))
